...
try:
    ...
    # Nos ajuda a entender como os dados estão concentrados, se próximo a média, ou mais espalhados.
    ...
    print(f'Erro ao calcular medida de distribuião: {e}')
...
# POSIÇÃO 4 - MEDIDAS ESTATÍSTICAS
    ...
    plt.title('BOXPLT ROUBO DE VEÍCULO POR MUNICÍPIOS')
